...
class Mapos extends MY_Controller
{
    ...
    public function index()
    {
        ...
        }elseif($this->permission->checkPermission($this->session->userdata('permissao'), 'vRetomadas')){
            redirect('retomadas'); 
        }elseif($this->permission->checkPermission($this->session->userdata('permissao'), 'vTv')){
            redirect('tvinsert/imagemSafra'); 
        }elseif($this->permission->checkPermission($this->session->userdata('permissao'), 'vDp')){
            redirect('dp/bradesco'); 
        }else{
            redirect('mapos/indexPadrao'); 
        }
    }
    ...
    public function configurar()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                ...
                'chamados_status_list' => json_encode($this->input->post('chamados_status_list')),
            ];
