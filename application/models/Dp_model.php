...
class Dp_model extends CI_Model
{
    ...
    public function getCdl($table, $fields, $where = [], $perpage = 0, $start = 0, $one = false, $array = 'array')
    {
        $lista_clientes = [];
        if ($where) {
      ...
      //  $this->db->join('servicos_os', 'servicos_os.os_id = os.idOs', 'left');
        ...
        $this->db->limit($perpage, $start);
        $this->db->order_by('cdl.idCdl', 'desc');
       // $this->db->group_by('cdl.idCdl');
    ...
    public function getBradesco($table, $fields, $where = [], $perpage = 0, $start = 0, $one = false, $array = 'array')
    {
        ...
        // condicional de status
        if (array_key_exists('pesquisa', $where)) {
            $this->db->like('num_gcpj', $where['pesquisa']);
            $this->db->or_like('nome_cliente', $where['pesquisa']);
        }
        
         // condicional de status
        if (array_key_exists('status', $where)) {
            $this->db->where_in('num_gcpj', $where['status']);
        }
        ...
        $this->db->limit($perpage, $start);
        $this->db->order_by('bradesco.id', 'desc');
       // $this->db->group_by('cdl.idCdl');
    ...
    public function getBradescoPesquisa($table, $fields, $where = [], $perpage = 0, $start = 0, $one = false, $array = 'array')
    {
        ...
        //return $this->db->count_all($result);
    }
    
    public function getCdlPesquisa($table, $fields, $where = [], $perpage = 0, $start = 0, $one = false, $array = 'array')
    {
        ...
        $this->db->from($table);
        if (array_key_exists('pesquisa', $where)) {
            $this->db->like('COD_CAUSA_EXYON', $where['pesquisa']);
            $this->db->or_like('NOME_DO_CLIENTE', $where['pesquisa']);
        }
        //$this->db->limit($perpage, $start);
        $this->db->order_by('cdl.idCdl', 'desc');
    ...
    public function getBradescoPesquisaCount($table, $fields, $where = [], $perpage = 0, $start = 0, $one = false, $array = 'array')
    {
     ...
     public function getCdlPesquisaCount($table, $fields, $where = [], $perpage = 0, $start = 0, $one = false, $array = 'array')
    {
    ...
    public function getBradescoPesquisaSoma($table, $fields, $where = [], $one = false, $array = 'array')
    {
    ...
    public function getCdlPesquisaSoma($table, $fields, $where = [], $perpage = 0, $start = 0, $one = false, $array = 'array')
    {
    ...
    public function addImport($table, $data, $returnId = false)
    {
        //$this->db->insert($table, $data);
         ...
         while(($line = $data) !== FALSE){
	                //check whether financeiro already exists in database with same email
	                    ...
	                    $this->db->insert($table, array("NOME_DO_ESCRITORIO"=>$line[0],
                                                           "REMESSA_N"=>$line[1],
    ...
    {
       $sql = "SELECT round(SUM(valor),2) AS total FROM bradesco";

        return $this->db->query($sql)->result();
    }
    
     public function getBradescoSum($table, $fields, $where = [], $one = false, $array = 'array')
    {
