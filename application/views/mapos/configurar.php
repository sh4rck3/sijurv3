    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#menu5">Agendamentos</a></li>
                <li><a data-toggle="tab" href="#menu6">Chamados</a></li>
            </ul>
                    ...
                    <div id="menu6" class="tab-pane fade">
                        <div class="control-group">
                            <div class="span8">
                                <span6 class="span10" style="margin-left: 1em;"> Defina a vizualização padrão, onde o que ficar checado será exibida na listagem de Agendamentos por padrão. </span6>
                                <div class="span10">
                                    <label> <input <?= @in_array("Em uso", json_decode($configuration['chamados_status_list'])) == 'true' ? 'checked' : ''; ?> name="chamados_status_list[]" class="marcar" type="checkbox" value="Em uso"> <span class="lbl"> Em uso</span> </label>
                                    <label> <input <?= @in_array("Em Andamento", json_decode($configuration['chamados_status_list'])) == 'true' ? 'checked' : ''; ?> name="chamados_status_list[]" class="marcar" type="checkbox" value="Em Andamento"> <span class="lbl"> Em Andamento</span> </label>
                                    <label> <input <?= @in_array("Orçamento", json_decode($configuration['chamados_status_list'])) == 'true' ? 'checked' : ''; ?> name="chamados_status_list[]" class="marcar" type="checkbox" value="Orçamento"> <span class="lbl"> Orçamento</span> </label>
                                    <label> <input <?= @in_array("Finalizado", json_decode($configuration['chamados_status_list'])) == 'true' ? 'checked' : ''; ?> name="chamados_status_list[]" class="marcar" type="checkbox" value="Finalizado"> <span class="lbl"> Finalizado</span> </label>
                                    <label> <input <?= @in_array("Cancelado", json_decode($configuration['chamados_status_list'])) == 'true' ? 'checked' : ''; ?> name="chamados_status_list[]" class="marcar" type="checkbox" value="Cancelado"> <span class="lbl"> Cancelado</span> </label>
                                    <label> <input <?= @in_array("Aguardando Peças", json_decode($configuration['chamados_status_list'])) == 'true' ? 'checked' : ''; ?> name="chamados_status_list[]" class="marcar" type="checkbox" value="Aguardando Peças"> <span class="lbl"> Aguardando Peças </span> </label>
                                    <label> <input <?= @in_array("Guardado", json_decode($configuration['chamados_status_list'])) == 'true' ? 'checked' : ''; ?> name="chamados_status_list[]" class="marcar" type="checkbox" value="Guardado"> <span class="lbl"> Guardado </span> </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
