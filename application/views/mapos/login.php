...
<h2 class="h-two"> Ao Sistema de auxilio a usuarios da Dunice e Marcon<br>
Desenvolvido pelo pessoal da TI.
</h2>
            ...
            <div class="content">
              <div id="newlog">
                <div class="icon2">
                  ...
                  <div class="title01" style="color: white;">
                    <h1>SIJUR</h1>
<!--                  <img src="<?php base_url() ?>/assets/img/logo-mapos-branco.png">-->
                </div>
              </div>
              ...
              <div class="links-uteis"><a href="http://ti.dunice.net"><p><?= date('Y'); ?> &copy; Luccas Woiciechoski</p></a>
              </div>
