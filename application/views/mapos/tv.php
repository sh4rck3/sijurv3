...
var GaugeController = Chart.controllers.doughnut.extend({
  ...
  */
  ...
  drawValueLabel: function drawValueLabel(ease) {
    ...
    var rotation = this.chart.options.rotation % (Math.PI * 0.1);
...
return index;
  ...
  -ms-user-select: none;
   ...
   <meta http-equiv="refresh" content="10;url=http://sijur.dunice.net/index.php/tv"> 
</head>
...
<body style="background-color: #363636;">
 ...
 //var_dump($results);
//  if(isset($results)){
//      echo '<h1>está cheio</h1>';
//  }else{
//      echo '<h1>está vazio</h1>';
//  }
 ...
 $valorComercial = ($batido_comercial / $meta_comercial) * 100;
 
 $valorVeiculo = ($batido_veiculo / $meta_veiculo) * 100;
 $valorImovel = ($batido_imovel / $meta_imovel) * 100;
 //echo '<h1>'. intval($valorVeiculo).'</h1>';
 ...
 //echo intval($valor);
  ...
  ?>
    <div style="margin-left: 50px;">
        <div id="canvas-holder" style="width:30%; float: left; margin-top: 125px; margin-left: 10px;">
          <div style="text-align: center; font-size: 28px; font-family:Arial; color: white; -webkit-text-stroke-width: 2px; -webkit-text-stroke-color: #363636;">
              <h1>Carteira Comercial</h1>   
          </div>    
   
          <canvas id="chart"></canvas>

          <div style="border: solid 2px white; margin-top: 10px; font-family:Arial; -webkit-text-stroke-width: 2px; -webkit-text-stroke-color: #363636;">
              <div style="text-align: center; font-size: 40px; color: white;">
                  <h3><b>Meta: R$ <?php echo number_format($meta_comercial, 2, ',', '.') ?></b><br></h3>
              </div>
          ...
          <div style="border: solid 2px white; margin-top: 10px; font-family:Arial; -webkit-text-stroke-width: 2px; -webkit-text-stroke-color: #363636;">
              <div style="text-align: center; font-size: 40px; color: white;">
                  <h3><b>Valor Recuperado: <br>R$ <?php echo number_format($batido_comercial, 2, ',', '.') ?></b><br></h3>
              </div>

          </div>
      </div>
    <div id="canvas-holder" style="width:30%; float: left; margin-top: 115px; margin-left: 30px;">
          <div style="text-align: center; font-size: 30px; font-family:Arial; color: white; -webkit-text-stroke-width: 2px; -webkit-text-stroke-color: #363636;">
              <h1>Carteira Veículo</h1>   
          </div>    
          ...
          <div style="border: solid 2px white; margin-top: 10px; font-family:Arial; -webkit-text-stroke-width: 2px; -webkit-text-stroke-color: #363636; ">
              <div style="text-align: center; font-size: 40px; color: white;">
                  <h3><b>Meta: R$ <?php echo number_format($meta_veiculo, 2, ',', '.') ?></b><br></h3>
              </div>

          </div>

          <div style="border: solid 2px white; margin-top: 10px; font-family:Arial; ">
              <div style="text-align: center; font-size: 40px; color: white; -webkit-text-stroke-width: 2px; -webkit-text-stroke-color: #363636;">
                  <h3><b>Valor Recuperado: <br>R$ <?php echo number_format($batido_veiculo, 2, ',', '.') ?></b><br></h3>
              </div>
    ...
    <div id="canvas-holder" style="width:30%; float: left; margin-top: 115px; margin-left: 30px;">
          ...
          <div style="border: solid 2px white; margin-top: 10px; font-family:Arial; -webkit-text-stroke-width: 2px; -webkit-text-stroke-color: #363636;">
              <div style="text-align: center; font-size: 40px; color: white;">
                  <h3><b>Meta: R$ <?php echo number_format($meta_imovel, 2, ',', '.') ?></b><br></h3>
              </div>
          ...
          <div style="border: solid 2px white; margin-top: 10px; font-family:Arial; -webkit-text-stroke-width: 2px; -webkit-text-stroke-color: #363636;">
              <div style="text-align: center; font-size: 40px; color: white;">
                  <h3><b>Valor Recuperado: <br>R$ <?php echo number_format($batido_imovel, 2, ',', '.') ?></b><br></h3>
              </div>
...
var config = {
  ...
  data: {
    ...
    datasets: [{
      ...
      value: ['<?php echo intval($valorComercial); ?>'],
...
var config3 = {
  ...
  data: {
    //labels: ['Success', 'Warning', 'Warning', 'Error'],
    datasets: [{
      data: ['25', '50', '75', '100', '145'],
      value: ['<?php echo intval($valorVeiculo); ?>'],
      backgroundColor: ['red', 'yellow', 'orange', 'blue', 'green'],
      borderWidth: 2
    }]
  },
...
var config2 = {
  ...
  data: {
    ...
    datasets: [{
      data: ['25', '50', '75', '100', '125'],
      value: ['<?php echo intval($valorImovel); ?>'],
      backgroundColor: ['red', 'yellow', 'orange', 'blue', 'green'],
      borderWidth: 2
    }]
  },
...
window.onload = function() {
  ...
  window.myGauge = new Chart(ctx, config2);
  
  var ctx = document.getElementById('chart2').getContext('2d');
  window.myGauge = new Chart(ctx, config3);
