    ...
    <ul class="nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="<?= site_url('relatorios/os') ?>">Agendamentos</a></li>
     ...
     <?php } ?>
      <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'menuTi')) { ?>
      <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Configurações" class="tip-bottom"><i class='bx bx-cog iconN'></i><span class="text"> TI Dunice</span></a>
        <ul class="dropdown-menu">
        <li><a href="<?= site_url('chamados/gerenciarTI') ?>">Ver Chamados</a></li>
        <li><a href="<?= site_url('ti/dashboard') ?>">Painel info</a></li>
        <li><a href="<?= site_url('ti/parque') ?>">Inventário</a></li>
...
<div id="userr" style="padding-right:45px;display:flex;flex-direction:column;align-items:flex-end;justify-content:center;">
  ...
  <div class="profile">
    <div class="profile-img">
      <a href="<?= site_url('mapos/minhaConta'); ?>"><img src="<?= base_url() . "assets/img/UserH.png"?>" alt=""></a>
    </div>
  </div>
</section>
