                ...
                <div class="widget-content">
                    ...
                    <div class="accordion" id="collapse-group">
                                ...
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <input name="vConfig" class="marcar" type="checkbox" value="1" />
                        ...
                        <div class="accordion-group widget-box">
                            <div class="accordion-heading">
                                <div class="widget-title">
                                    <a data-parent="#collapse-group" href="#collapseGThree3333356" data-toggle="collapse">
                                        <span class="icon"><i class="fas fa-key"></i></span>
                                        <h5>Chamados</h5>
                                    </a>
                                </div>
                            </div>
                            <div class="collapse accordion-body" id="collapseGThree3333356">
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        <tbody>
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vChamados" class="marcar" type="checkbox" checked="checked" value="1" />
                                                    <span class="lbl"> Visualizar Chamados</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="aChamados" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Adicionar Chamados</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="eChamados" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Editar Chamados</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="dChamados" class="marcar" type="checkbox" value="1" />
                                ...
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vParque" class="marcar" type="checkbox" checked="checked" value="1" />
                                                    <span class="lbl"> Visualizar Parque</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="aParque" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Adicionar Parque</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="eParque" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Editar Parque</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="dParque" class="marcar" type="checkbox" value="1" />
                        ...
                        <div class="accordion-group widget-box">
                            <div class="accordion-heading">
                                <div class="widget-title">
                                    <a data-parent="#collapse-group" href="#collapseGThree33333567" data-toggle="collapse">
                                        <span class="icon"><i class="fas fa-key"></i></span>
                                        <h5>Bradesco</h5>
                                    </a>
                                </div>
                            </div>
                            <div class="collapse accordion-body" id="collapseGThree33333567">
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        <tbody>
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vBradesco" class="marcar" type="checkbox" checked="checked" value="1" />
                                                    <span class="lbl"> Visualizar Bradesco</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="aBradesco" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Adicionar Bradesco</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="eBradesco" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Editar Bradesco</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="dBradesco" class="marcar" type="checkbox" value="1" />
                        ...
                        <div class="accordion-group widget-box">
                            <div class="accordion-heading">
                                <div class="widget-title">
                                    <a data-parent="#collapse-group" href="#collapseGThree333335678" data-toggle="collapse">
                                        <span class="icon"><i class="fas fa-key"></i></span>
                                        <h5>Financeiro DP</h5>
                                    </a>
                                </div>
                            </div>
                            <div class="collapse accordion-body" id="collapseGThree333335678">
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        <tbody>
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vDp" class="marcar" type="checkbox" checked="checked" value="1" />
                                                    <span class="lbl"> Visualizar DP</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="aDp" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Adicionar DP</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="eDp" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Editar DP</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="dDp" class="marcar" type="checkbox" value="1" />
                        ...
                        <div class="accordion-group widget-box">
                            <div class="accordion-heading">
                                <div class="widget-title">
                                    <a data-parent="#collapse-group" href="#collapseGThree3333356789" data-toggle="collapse">
                                        <span class="icon"><i class="fas fa-key"></i></span>
                                        <h5>Recursos Humanos</h5>
                                    </a>
                                </div>
                            </div>
                            <div class="collapse accordion-body" id="collapseGThree3333356789">
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        <tbody>
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vRh" class="marcar" type="checkbox" checked="checked" value="1" />
                                                    <span class="lbl"> Visualizar RH</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="aRh" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Adicionar RH</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="eRh" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Editar RH</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="dRh" class="marcar" type="checkbox" value="1" />
                                ...
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vRetomadas" class="marcar" type="checkbox" checked="checked" value="1" />
                                                    <span class="lbl"> Visualizar Retomadas</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="aRetomadas" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Adicionar Retomadas</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="eRetomadas" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Editar Retomadas</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="dRetomadas" class="marcar" type="checkbox" value="1" />
                        ...
                        <div class="accordion-group widget-box">
                            <div class="accordion-heading">
                                <div class="widget-title">
                                    <a data-parent="#collapse-group" href="#collapseGThree33333567891" data-toggle="collapse">
                                        <span class="icon"><i class="fas fa-key"></i></span>
                                        <h5>Controle TV's</h5>
                                    </a>
                                </div>
                            </div>
                            <div class="collapse accordion-body" id="collapseGThree33333567891">
                                <div class="widget-content">
                                    <table class="table table-bordered">
                                        <tbody>
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="vTv" class="marcar" type="checkbox" checked="checked" value="1" />
                                                    <span class="lbl"> Visualizar TV</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="aTv" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Adicionar TV</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="eTv" class="marcar" type="checkbox" value="1" />
                                                    <span class="lbl"> Editar TV</span>
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="dTv" class="marcar" type="checkbox" value="1" />
