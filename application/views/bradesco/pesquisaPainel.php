...
<div class="widget-box">
    <div class="widget-title">
        ...
        <h5>Planilha de controle do Bradesco -> <b style="color: green;">Total de registros com a observação:</b> <?php print_r($termoPesquisado) ?>: <b style="color: red;"><?php print_r($totalEncerramento); ?></b></h5>
