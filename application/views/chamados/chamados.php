    ...
    <div class="widget-content nopadding tab-content">
        <table id="tabela1" class="table table-bordered">
            ...
            foreach ($results as $r) {
                ...
                //echo '<td>' . $r->status . '</td>';
                echo '<td style="width: 20%;">' . mb_strimwidth($r->observacao, 0, 220, "...")  . '</td>';
                ...
                if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eChamados')) {
                    if( $r->status == 'Novo'){
                    echo '<a href="' . base_url() . 'index.php/chamados/abrir/' . $r->idClientes . '" style="margin-right: 1%" class="btn-nwe3" title="Editar"><i class="bx bx-edit"></i></a>';
                    } else {
                        if( $r->status == 'Fechado'){
                            $disable = 'pointer-events: none';
                    echo '<a href="' . base_url() . 'index.php/chamados/responder/' . $r->idClientes . '" style="margin-right: 1%; '.$disable.'" class="btn-nwe3" title="Editar"><i class="bx bx-edit"></i></a>';    
                        } else {
                    echo '<a href="' . base_url() . 'index.php/chamados/responder/' . $r->idClientes . '" style="margin-right: 1%" class="btn-nwe3" title="Editar"><i class="bx bx-edit"></i></a>';        
                        }
                    }
                ...
                if ($this->permission->checkPermission($this->session->userdata('permissao'), 'cBackup')) {
                    ...
                    echo '<a href="#modal-excluir" role="button" data-toggle="modal" cliente="' . $r->idClientes . '" style="margin-right: 1%; '.$disable2.'" class="btn-nwe4" title="Excluir"><i class="bx bx-trash-alt"></i></a>';
                    }else{
                        echo '<a href="#modal-excluir" role="button" data-toggle="modal" cliente="' . $r->idClientes . '" style="margin-right: 1%" class="btn-nwe4" title="Excluir"><i class="bx bx-trash-alt"></i></a>';
                    }
