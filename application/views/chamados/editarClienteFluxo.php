...
<div class="row-fluid" style="margin-top:0">
 ...
 <div class="buttons">
                    <a title="Voltar" class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/cobranca/adicionarFluxo?nomeFluxo=<?php echo $result->nomeCliente; ?>&idFluxo=<?php echo $result->idClientes; ?>"><i
                                class="fas fa-arrow-left"></i> Adiconar ao Fluxo</a>
                </div>
            </div>
