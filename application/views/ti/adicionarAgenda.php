    ...
    <div class="span12">
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Cadastro na Agenda</h5>
            </div>
            <div class="widget-content nopadding tab-content">
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">

                    <ul class="nav nav-tabs">
                        <li class="active" id="tabDetalhes"><a href="#tab1" data-toggle="tab">Detalhes da agenda</a></li>
                    </ul>
                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    <div class="span12" style="padding: 1%">
                                        <div class="span6">
                                            <label for="clienteAgenda">Cliente<span class="required">*</span></label>
                                            <input id="clienteAgenda" class="span12" type="text" name="clienteAgenda" value="" />
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span3">
                                            ...
                                            <input id="dataAgenda" autocomplete="off" class="span12" type="date" name="dataAgenda" value="" />
                                        </div>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span6 offset3" style="text-align: center">
                                            ...
                                            <a href="<?php echo base_url() ?>index.php/agenda" class="btn"><i class="fas fa-backward"></i> Voltar</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
