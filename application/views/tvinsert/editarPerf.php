                        ...
                        <div class="tab-pane active" id="tab1">
                            <div class="span12" id="divEditarVenda">
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                    <?php echo form_hidden('idPerf', $result->idPerf) ?>
                                    <div class="span12" style="padding: 1%">
                                        <div class="span2">
                                            <label for="dataInsercao">Data<span class="required">*</span></label>
                                            <input id="dataInsercao" class="span12" type="text" name="dataInsercao" value="<?php echo date('d/m/Y', strtotime($result->dataInsercao)); ?>" readonly />
                                        </div>
                                        <div class="span4" >
                                            <label for="nomeCliente">Nome do Cliente</label>
                                            <input class="span12" type="text" name="nomeCliente" id="nomeCliente" value="<?php echo $result->nomeCliente ?>"/>
                                        </div>
                                        <div class="span2" >
                                            <label for="agencia">Agência</label>
                                            <input class="span12" type="text" name="agencia" id="agencia" value="<?php echo $result->agencia ?>"/>
                                        </div>
                                        <div class="span2" >
...
<!--                                                <option value="LP">Lucro Perdido</option>-->
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span8 offset2" style="text-align: center">
                                            ...
                                            <a href="<?php echo base_url() ?>index.php/vendas/acomPerformance" class="btn"><i class="fas fa-backward"></i> Voltar</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <form id="formProdutos" action="<?php echo base_url(); ?>index.php/vendas/adicionarProduto" method="post">
                                    <div class="span6">
                                        ...
                                        <input type="hidden" name="idPerfProduto" id="idPerfProduto" value="<?php echo $result->idPerf ?>" />
    ...
    <form id="formFaturar" action="<?php echo current_url() ?>" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="span12" style="margin-left: 0">
                ...
                <input class="span12" id="descricao" type="text" name="descricao" value="Fatura de Venda - #<?php echo $result->idPerf; ?> " />
            </div>
            <div class="span12" style="margin-left: 0">
                <div class="span12" style="margin-left: 0">
                    ...
                    <input type="hidden" name="vendas_id" id="vendas_id" value="<?php echo $result->idPerf; ?>">
                </div>
            </div>
            <div class="span12" style="margin-left: 0">
