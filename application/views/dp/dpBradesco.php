...
<div class="widget-box">
    <div class="widget-title">
        ...
        <h5>Remessa BRADESCO, a soma de todas as remessa e de: R$ <?php 
 //var_dump($teste4);
 echo number_format($teste, 2, ',', '.'); ?></h5>
    </div>
                ...
                <tbody>
                    ...
                    foreach ($results as $r) {
                        ...
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vProduto')) {
                            echo '<a style="margin-right: 1%" href="#modal-ver' . $r->id . '" role="button" data-toggle="modal"  class="btn-nwe" title="Ver mais detalhes"><i class="bx bx-show"></i></a>';
                        }
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'qProduto'))  {
                            echo '<a style="margin-right: 1%" href="' . base_url() . 'index.php/dp/editar/' . $r->id . '" class="btn-nwe3" title="Editar"><i class="bx bx-edit"></i></a>';
                        }
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'qProduto') ) {
                            echo '<a href="#modal-excluir" role="button" data-toggle="modal" os="' . $r->id . '" class="btn-nwe4" title="Excluir"><i class="bx bx-trash-alt"></i></a>';
                        }
                        echo '</td>';
                        echo '</tr>';
                       } ?>
